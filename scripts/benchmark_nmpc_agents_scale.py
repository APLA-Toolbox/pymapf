...
sim.register_agent("6", Position(20, 20), Position(0, 0), vmin=0)
sim.register_agent("7", Position(20, 0), Position(0, 20), vmin=0)
sim.register_agent("8", Position(0, 20), Position(20, 0), vmin=0)
stamp = time.time()
sim.run_simulation()
runtimes_per_agents = {}
for key, agent in sim.agents.items():
