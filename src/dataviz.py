...
class DataViz:
    def __init__(self, world, agents):
        ...
        for agent in agents:
            ...
            plt.plot(agent.init_pos[0], agent.init_pos[1], marker='o', color=self.agents_colors[agent.id])
            plt.plot(agent.goal_pos[0], agent.goal_pos[1], marker='x', color=self.agents_colors[agent.id])
